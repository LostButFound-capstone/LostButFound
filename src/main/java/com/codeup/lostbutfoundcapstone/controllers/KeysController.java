...
import com.codeup.lostbutfoundcapstone.models.ConfigProperties;
...
public class KeysController {
    ...
    public String apikey(){
        ...
        for (Map.Entry<String,String> entry : configProperties.getJsKeys().entrySet()){
            ...
            System.out.println(String.format("const %s_API_KEY = '%s';\n", entry.getKey().toUpperCase(), entry.getValue()));
        }

        return keysJs.toString();
    }
}
//const FileStackAPI = "AblINtgTYS3OkvAkSISfxz";